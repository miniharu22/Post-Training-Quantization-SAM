...
# YOLOv6/tools/quantization/tensorrt/post_training/onnx_to_tensorrt.py
import os
import sys
import glob
import math
...
## python3 onnx_to_tensorrt.py --onnx ".onnx path" --int8  --clibration-data "data_path"
def main():
    parser = argparse.ArgumentParser(description="Creates a TensorRT engine from the provided ONNX file.\n")
    parser.add_argument("--onnx", required=True, help="The ONNX model file to convert to TensorRT") #path of .onnx weight file
